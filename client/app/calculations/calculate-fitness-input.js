...
const { age, heightInFeet, heightInInches, currentWeight, gender, activityLevel } = clientInfo;
...
if (gender == 'man' && activityLevel.match('sedentary') !== null) {
  ...
  else if(gender == 'man' && activityLevel == active.match('heavy') !== null){
  ...
  else if(gender == 'woman' && activityLevel == activityLevel.match('heavy') !== null){
