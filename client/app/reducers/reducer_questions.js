...
//         {question: "How active are you?", answers: ["sedentary (little or no exercise)", "moderate (exercise 3-5 days per week)", "heavy (exercise 6-7 times per week)"], userInput: 4, tag: "clock", answerType: "radio"}
//      ];
// }
