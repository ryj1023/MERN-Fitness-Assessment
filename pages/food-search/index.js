...
import {
    ...
    getUserData,
} from '../../client/app/actions/async-actions'
...
class FoodSearch extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.selectedFoodFacts !== prevState.selectedFoodFacts) {
            const nutritionFactUnits = this.props.nutritionFacts.reduce(
                (acc, data) => {
            ...
            if (this.props.nutritionFacts[0]) {
                nutritionFactUnits.push(
                    `${this.props.nutritionFacts[0].measures[0].qty}`
                )
            }
            this.setState({
                selectedFoodFacts: this.state.selectedFoodFacts,
                microNutrients,
                nutritionFactUnits,
            })
        }
    ...
    showFoodNutrients(selectedFood) {
        this.props.getFoodNutritionFacts(
            selectedFood.foodID,
    ...
    async addSelectedFoodToFoodList(
        selectedFoodName,
        selectedFoodFacts,
        userData
    ) {
    ...
    updateServingSize(servingSize) {
        ...
        if (
            parseFloat(servingSize) ===
                parseFloat(this.props.nutritionFacts[0].measures[0].qty) ||
            servingSize === ''
        ) {
            this.setState({
                customFoodFacts: [],
    ...
    showNutrientFacts() {
        ...
        const microNutrients =
            this.state.servingSize !== ''
                ? customMicroNutrients
                : this.state.microNutrients
        const selectedFoodFacts =
            this.state.servingSize !== ''
                ? customFoodFacts
                : this.state.selectedFoodFacts
        const nutritionFactUnits =
            this.state.servingSize !== ''
                ? customNutritionFactUnits
                : this.state.nutritionFactUnits
        console.log('this.props.nutritionFacts', this.props.nutritionFacts)
        return (
            <>
                <Col className="m-auto" xs="12" lg="10">
                    <Card>
                        {/* <CardBody>
                            ...
                            <SmartTable
                                updateServingSize={servingSize =>
                                    this.updateServingSize(servingSize)
                                }
                                responsive={false}
                                id={'food-search'}
                                width="100%"
                                ...
                                titleHeader={true}
                                servingType={
                                    this.props.nutritionFacts[0] &&
                                    this.props.nutritionFacts[0].measures[0]
                                        .label
                                        ? this.props.nutritionFacts[0]
                                              .measures[0].label
                                        : null
                            ...
                            <div className="d-flex justify-content-sm-start d-flex justify-content-between">
                                <Button
                                    onClick={this.backToFoodResults.bind(this)}
                                ...
                                {this.state.userData && (
                                    <Button
                                        ...
                                        onClick={async () =>
                                            await this.addSelectedFoodToFoodList(
                                                this.state.selectedFoodName,
                                                selectedFoodFacts,
                                                this.state.userData
                                            )
                                        }
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        this.setState({
                                            micronutrientsModalOpen: !micronutrientsModalOpen,
                                        })
                                    }
                                >
                                    Show micronutrients
                    ...
                    <div className="text-center">
                        <Modal
                            isOpen={micronutrientsModalOpen}
                            toggle={() =>
                                this.setState({
                                    micronutrientsModalOpen: !micronutrientsModalOpen,
                                })
            ...
            if (index + 1 >= pageRange && acc.length < 10) {
                acc.push(
                    <li
                        ...
                        key={index}
                        id={foodID}
                        onClick={this.showFoodNutrients.bind(this, {
                            foodID,
                            foodName,
                        })}
                    >
            ...
            >
                <div className="mb-2 mb-md-0 d-flex align-items-center">
                    ...
                    {foodTextInput && foodList.length > 0 && (
                        <button
                            onClick={() =>
                                this.setState({ recipesModalOpen: true })
                            }
            ...
            <div>
                <div className="container-fluid food-search-container">
                    ...
                    <RecipesModal
                        ...
                        recipesModalOpen={recipesModalOpen}
                        onClose={() =>
                            this.setState({ recipesModalOpen: false })
                        }
                    />
                </div>
                <style jsx="true">{`
